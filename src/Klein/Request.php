...
class Request
{
    ...
    /**
     * Create a new request object using the built-in "super globals"
     *
     ...
     *
     * @return ServerDataCollection|DataCollection
     */
    public function server(): ServerDataCollection|DataCollection
    {
        return $this->server;
    }
     ...
     *
     * @param array|string $key The name of the query param
     * @param mixed|null $value The value of the query param
     * @return string
     */
    public function query(array|string $key, mixed $value = null): string
    {
        $query = array();
